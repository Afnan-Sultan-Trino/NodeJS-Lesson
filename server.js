...
// For response, we can do status code, content-type using writeHead(), write()
...
const myServer= http.createServer((req,res)=>{ 
    ...
    res.writeHead(203,{'content-type':'text/html'})   // {203} for status code and Content type is html, if using html tag
    res.write("<h1>Hello, I am your First Server</h1>")
    res.write("<p>We can create status code, content type</p>")
